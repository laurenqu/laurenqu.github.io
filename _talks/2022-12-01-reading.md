![image](https://github.com/lingyunqu/lingyunqu.github.io/assets/121205164/d29b231d-bae7-4afa-9cc5-bd1ea574cb8e)---
...
Authors first uses dynamic programming to compute the optimal action to select for every possible combination of the situational variables. With initial current resource and trustworthiness of others, each of the three actions can be optimal. The optimality of exploitation below the critical level of resources is generally insensitive to increasing the severity of punishment. The exploitation boundary is slightly more sensitive to the probability of punishment.
