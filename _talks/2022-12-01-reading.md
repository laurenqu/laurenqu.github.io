...
This paper discusses the two-person households in which both partners search for jobs instead of the standard bachelor model. The paper finfs that, when in (1) the presence of on-the-job search, with equal search effectiveness on and off the job, or (2) presence of loose borrowing limits, In both cases, a risk-averse couple acts like a single agent who has the possibility of holding multiple jobs. What makes a difference is a flow cost of living apart for the two spouses in the couple.
